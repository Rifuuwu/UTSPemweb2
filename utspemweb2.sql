...
-- Dumping data for table kuliah.dosen: ~1 rows (approximately)
...
-- Dumping data for table kuliah.mata_kuliah: ~1 rows (approximately)
...
-- Dumping data for table kuliah.ruangan: ~1 rows (approximately)
...
-- Dumping data for table kuliah.jadwal: ~3 rows (approximately)
